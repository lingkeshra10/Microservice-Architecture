...
public class EmailServiceManagement {
    ...
    public int sendHtmlEmail(String username, String notificationEmail, String emailNotificationType) {
        try {
            ...
            String subject = "";
            String emailContent = switch (emailNotificationType) {
                case "1" -> {
                    subject = "Welcome to BlackRock Application";
                    yield "Hai, " + username + " thank you for choosing our applications.";
                }
                case "2" -> {
                    subject = "Password Updated";
                    yield "Hai, " + username + " we have successfully updated password for your account. " +
                            "If you didnt perform this action please contact the administrator.";
                }
                case "3" -> {
                    subject = "Unusual Login";
                    yield "Hai, " + username + " we have detected unusual login to your application.";
                }
                case "4" -> {
                    subject = "Payment Due Date";
                    yield "Hai, " + username + " we have notice your account reach due date for the payment. " +
                            "Please perform your payment for continuing your premium version";
                }
                case "5" -> {
                    subject = "Dissolve Premium Account";
                    yield "Hai, " + username + " due to the payment for the account not been paid. " +
